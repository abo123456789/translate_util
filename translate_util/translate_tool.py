...
def translate_en2cn(content: str, platform: str = 'google', proxies: str = None):
    ...
    try:
        if platform == 'google':
            ...
            return IcibaTranslate(content=content, proxies=proxies).trans_text_en2cn()
...
def translate_other2cn(content: str, platform='google', proxies: str = None):
    ...
    try:
        if platform == 'google':
            ...
            return IcibaTranslate(content=content, proxies=proxies).trans_text_other2cn()
        elif platform == 'youdao':
...
def translate_other2en(content: str, platform='google', proxies: str = None):
    ...
    try:
        if platform == 'google':
            ...
            return IcibaTranslate(content=content, proxies=proxies).trans_text_other2en()
        elif platform == 'youdao':
